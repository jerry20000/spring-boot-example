...
import cn.com.jerry.order.sharding.ModuloShardingDatabaseAlgorithm;
import cn.com.jerry.order.sharding.ModuloShardingTableAlgorithm;
import cn.com.jerry.utils.DataSourceUtil;
...
public class DataSourceConfig {
    ...
    public DataSource userShardingDataSource() throws SQLException {
        ...
        result2.setActualDataNodes("db${0..1}.t_order${[0,1]}");
        ...
        dbMap.put("db0", DataSourceUtil.dataSource("db0"));
        dbMap.put("db1", DataSourceUtil.dataSource("db1"));
